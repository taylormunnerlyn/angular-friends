angular.module("friendsApp").controller("mainCtrl", function($scope) {
  $scope.sortProp = "";
  ...
  var friendsEdited = friends.map(function(person) {
  ...
  console.log(friendsEdited);

  $scope.friendsEdited = friendsEdited;
